#ifndef CPP2_SCP_CONTAINERS_SCP_CONTAINERS_SET_SCP_SET_H_
#define CPP2_SCP_CONTAINERS_SCP_CONTAINERS_SET_SCP_SET_H_
...
#endif  // CPP2_SCP_CONTAINERS_SCP_CONTAINERS_SET_SCP_SET_H_
